...
The first downstream adoption is commits `db6ca8d40` and `64d1f5405`; the
second downstream adoption is commit `9ce05709`.
...
The final exactness audit for the second downstream repository added
transitive frontend artifact dependencies, SDK generator inputs, and the
Elixir workspace input in `1dd6a784`. Positive
...
product build was required there.
