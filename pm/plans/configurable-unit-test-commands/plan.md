...
- Synchronize all affected reusable skills and generated portable policy
  copies.
- Configure Ponytail and two governed downstream repositories.
...
- Initial governed consumers: two downstream repositories.
...
- Ponytail and both governed consumers contain exact command values discovered
  from their authoritative scripts and package configuration.
...
Completed. Portable policy, generated host copies, and all three host
configurations expose named focused/full unit-test families. Focused
