...
description: >-
  Use whenever performing or continuing a Git rebase. Replay and review every
  commit separately, resolving both textual conflicts and cleanly applied
  semantic conflicts before continuing.
---
