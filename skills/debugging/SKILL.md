...
name: debugging
description: >-
  Use whenever diagnosing or fixing a bug, failed test, unexpected behavior,
  performance regression, build failure, integration failure, or unsuccessful
  prior fix. Establish the root cause through differential diagnosis and
  minimal hypothesis tests before implementation.
---
