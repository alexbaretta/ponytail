...
name: build-impact
description: >-
  Use before running a project build for change validation. Query the
  project-owned Ponytail build-impact configuration with the bundled
  TypeScript adapter and any configured custom language adapters, then build
  only reported targets after their final input edits.
---
