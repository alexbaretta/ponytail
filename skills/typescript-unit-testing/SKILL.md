...
description: >-
  Use whenever creating, editing, reviewing, or fixing TypeScript unit tests,
  test fixtures, test-data factories, or test doubles. Keep valid test values
  and behavioral doubles statically tied to their production TypeScript
  contracts, represent invalid inputs honestly, and follow any test indexes,
  audit metadata, and regeneration commands declared by project configuration.
---
