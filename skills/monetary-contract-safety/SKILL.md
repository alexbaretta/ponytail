...
description: >-
  Use when defining, editing, reviewing, documenting, or testing an owned
  public monetary or decimal-capable contract, or an implementation, SDK,
  generated client, example, or language binding that carries that contract.
  Require unquoted JSON number tokens, lossless parsing and serialization,
  and TypeScript LosslessNumber values from the lossless-json package.
---
